                ...
                <header class="masthead">
                    <form action="" method="post">
                        ...
                        <div>
                            ...
                            <label>Email</label>
                <input type="email" required placeholder="email" name="email" value="mo@gmail" >
                        </div>
                        <br>
                        <br>
                        ...
                        <div class="pass">
                        <label>password</label>
                        <input type="password" required placeholder="pass" name="pass1" minlength="10" maxlength="20">
                        </div>
                        <br>
                        
                        <input type="submit" value="login" class="mm" name="sub" >
                        </div>
                        <?php
                         if(isset($_POST["sub"])){
                                ...
                                if($ret){
                                    echo'<div class="zz"> <h2> تمت العمليه بنجاح</h2></div>';
                                }
                                else{
                                    echo'<div class="zz"> <h2> ارجاءاعادة المحاوله</h2></div>';
                                }
                            }
                            }
...
<input type="email" required placeholder="email" name="email" value="mo@gmail" >
        ...
        <input type="submit" value="login" class="mm" >
        </div>
        <div class="landing">
        </div>
        <div class="img">
